...
public class LogViewCachedTextTrimmerTests
{
    [Fact]
    public void TrimToMaxBytes_returns_original_when_under_limit()
    {
        ...
        LogViewCachedTextTrimmer.TrimToMaxBytes(text, maxBytes: 256).Should().Be(text);
    }
    ...
    public void TrimToMaxBytes_keeps_tail_and_drops_head_on_line_boundary()
    {
        ...
        var trimmed = LogViewCachedTextTrimmer.TrimToMaxBytes(text, maxBytes: 262_144);
