    ...
    Action<bool>? onClose = null)
  {
    var titleBlock = new TextBlock
    {
      ...
      Foreground = owner is null
        ...
        : AppDialogButtonFactory.ResolveBrush(owner, "TextPrimary", Colors.Black),
    ...
    var messageBlock = new TextBlock
    {
      ...
      Foreground = owner is null
        ...
        : AppDialogButtonFactory.ResolveBrush(owner, "TextSecondary", Color.FromRgb(0x5C, 0x5C, 0x5C)),
      TextWrapping = TextWrapping.Wrap,
      LineHeight = 20,
    };
    ...
    if (showCancel)
    {
      var cancelButton = AppDialogButtonFactory.CreateTextButton("取消", owner);
    ...
    var primaryButton = AppDialogButtonFactory.CreatePrimaryButton(primaryLabel, owner);
    ...
    var surface = new Border
    {
      Background = owner is null
        ...
        : AppDialogButtonFactory.ResolveBrush(owner, "CardBackground", Colors.White),
      BorderBrush = owner is null
        ? new SolidColorBrush(Color.FromRgb(0xE5, 0xE5, 0xE5))
        : AppDialogButtonFactory.ResolveBrush(owner, "CardBorderBrush", Color.FromRgb(0xE5, 0xE5, 0xE5)),
