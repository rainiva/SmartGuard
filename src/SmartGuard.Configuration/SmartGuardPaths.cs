...
public static class SmartGuardPaths
{
  ...
  public static string EngineExe(string root) => Path.Combine(root, "bin", "SmartGuard.Engine.exe");
  public static string TrayExe(string root) => Path.Combine(root, "bin", "SmartGuard.Tray.exe");
  public static string SettingsExe(string root) => Path.Combine(root, "bin", "SmartGuard.Settings.exe");
